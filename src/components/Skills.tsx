...
const items = [
    {
        ...
        subItems: ["Java", "Python", "TypeScript", "JavaScript", "Android", "C#", "C", "Bash"],
    },
    {
        title: 'Databases',
    ...
    },
    {
        ...
        subItems: ["Maven", "Npm", "Yarn", "Webpack", "Azure Artifacts", "Artifactory", "Jenkins", "Git", "GitHub Actions",
            "Gitlab Pipelines", "Single SPA", "Web Components"],
    },
    {
        title: 'Infrastructure and Cloud',
        subItems: ["Terraform", "Helm charts", "Kubernetes", "Azure Services", "AWS EC2", "AWS S3", "AWS CF", "Docker", "Docker Container"],
    },
    {
        title: 'Event Driven',
