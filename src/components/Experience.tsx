...
const professionalExperience: TimelineItemData[] = [
	...
	},
	{
		...
		url: "https://www.voiceinteraction.ai",
		dateStart: "Oct 2022",
		dateEnd: "Mar 2024",
		type: "Full-time",
		description:
	...
	},
	{
		...
		url: "https://surething.tecnico.ulisboa.pt",
		dateStart: "Sep 2021",
		dateEnd: "Nov 2022",
		type: "Research",
		description:
			...
			>
				<AnimatedFadeInNode>
					...
					>
						...
						>
							<Work sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: (theme) => theme.palette.mode === "light" ? "#06B6D4" : "#FFFFFF" }} />
						</Box>
						<Typography
							variant="h1"
							sx={{
			...
			>
				<AnimatedFadeInNode>
					...
					>
						...
						>
							<School sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: (theme) => theme.palette.mode === "light" ? "#059669" : "#FFFFFF" }} />
						</Box>
						<Typography
							variant="h1"
							sx={{
